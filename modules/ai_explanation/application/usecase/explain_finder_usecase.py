...
from modules.ai_explanation.adapter.input.web.response.finder_response import FinderResponse
...
class ExplainFinderUseCase:
    ...
    def execute(self, request) -> FinderResponse:
        # Finder 전용 프롬프트 호출
        ...
        return FinderResponse(message=explanation)